...
/* Resize */
void Java_com_app_beseye_CameraViewActivity_onNativeResize(
...
/* Surface Created */
void Java_com_app_beseye_CameraViewActivity_onNativeSurfaceChanged(JNIEnv* env, jclass jcls)
{
    SDL_WindowData *data;
...
/* Surface Destroyed */
void Java_com_app_beseye_CameraViewActivity_onNativeSurfaceDestroyed(JNIEnv* env, jclass jcls)
{
...
void Java_com_app_beseye_CameraViewActivity_nativeFlipBuffers(JNIEnv* env, jclass jcls)
{
    SDL_GL_SwapWindow(Android_Window);
}

/* Keydown */
void Java_com_app_beseye_CameraViewActivity_onNativeKeyDown(
...
/* Keyup */
void Java_com_app_beseye_CameraViewActivity_onNativeKeyUp(
                                    JNIEnv* env, jclass jcls, jint keycode)
{
...
/* Keyboard Focus Lost */
void Java_com_app_beseye_CameraViewActivity_onNativeKeyboardFocusLost(
                                    JNIEnv* env, jclass jcls)
{
...
/* Touch */
void Java_com_app_beseye_CameraViewActivity_onNativeTouch(
                                    JNIEnv* env, jclass jcls,
...
/* Accelerometer */
void Java_com_app_beseye_CameraViewActivity_onNativeAccel(
                                    JNIEnv* env, jclass jcls,
...
/* Low memory */
void Java_com_app_beseye_CameraViewActivity_nativeLowMemory(
...
/* Quit */
void Java_com_app_beseye_CameraViewActivity_nativeQuit(
                                    JNIEnv* env, jclass cls)
{
...
/* Pause */
void Java_com_app_beseye_CameraViewActivity_nativePause(
                                    JNIEnv* env, jclass cls)
{
    if (Android_Window) {
...
/* Resume */
void Java_com_app_beseye_CameraViewActivity_nativeResume(
                                    JNIEnv* env, jclass cls)
{
