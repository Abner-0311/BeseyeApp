	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(null != txtVer){
			try {
				...
				txtVer.setText(String.format(getString(R.string.about_ver), packageInfo.versionName)+(BeseyeConfig.ALPHA_VER?" (α)":(BeseyeConfig.BETA_VER?" (β)":(BeseyeConfig.DEBUG?" (dev)":""))));
