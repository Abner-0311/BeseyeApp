...
public class BeseyeHttpWifiTask extends AsyncTask<String, Double, List<JSONObject>> {
	...
	public BeseyeHttpWifiTask setHttpMethod(String method){
		mHttpMethod = method;
		return this;
	}
	...
	public BeseyeHttpWifiTask(OnHttpTaskCallback cb){
		mOnHttpTaskCallback = new WeakReference<OnHttpTaskCallback>(cb);
	}
	
	public BeseyeHttpWifiTask(OnHttpTaskCallback cb, int iDialogId){
		this(cb);
		mDialogId = iDialogId;
	}
