...
JNIEXPORT void JNICALL Java_com_example_aubiotest_AubioTestActivity_finishPlayCode(JNIEnv * env, jobject thisObj){
	DECLARE_JNIENV_WITHOUT_RETURN()
...
//
//JNIEXPORT jint JNICALL Java_com_example_aubiotest_AubioTestActivity_launchFreqGenerator(JNIEnv * env, jobject thisObj, jstring strCurCode, jint iDigitalToTest)
//{
//	DECLARE_JNIENV_WITH_RETURN()
//
...
//
//
//JNIEXPORT jint JNICALL Java_com_example_aubiotest_AubioTestActivity_stopFreqGenerator(JNIEnv * env, jobject thisObj)
//{
...
void callbackFuncTest(void* data, const char* jsonRet){
	CAM_Event* event = (CAM_Event*)data;
	LOGE("callbackFunc(), event_id:%lld, jsonRet:%s", event->event_id, jsonRet);
}
...
JNIEXPORT void JNICALL Java_com_example_aubiotest_AubioTestActivity_startRecord(JNIEnv * env, jobject obj, int fd, int iSampleRate, int iFrameSize, int iNSIndex, float iAGCLevel, jboolean bDeverb, float fDeverbDecay, float dDeverbLevel)
{
...
JNIEXPORT jfloat JNICALL Java_com_example_aubiotest_AubioTestActivity_recordAudio(JNIEnv * env, jobject thisObj, jshortArray array, int iBufSize, jboolean bReset)
{
...
JNIEXPORT jfloat JNICALL Java_com_example_aubiotest_AubioTestActivity_analyzeAudio(JNIEnv * env, jobject thisObj, jshortArray array, int iBufSize, jboolean bReset){
...
JNIEXPORT void JNICALL Java_com_example_aubiotest_AubioTestActivity_runAudioPreprocess(JNIEnv * env, jobject thisObj, jshortArray array, jboolean bReset)
{
...
JNIEXPORT void JNICALL Java_com_example_aubiotest_AubioTestActivity_runAudioPreprocessAC(JNIEnv * env, jobject thisObj, jshortArray array, jboolean bReset)
{
	DECLARE_JNIENV_WITHOUT_RETURN()
	performSpeexPreprocess(env, thisObj, array, bReset, &stPreprocessAC);
}

JNIEXPORT jfloat JNICALL Java_com_example_aubiotest_AubioTestActivity_analyzeAudioViaDywa(JNIEnv * env, jobject thisObj, jshortArray array, int iBufSize)
{
...
JNIEXPORT jfloat JNICALL Java_com_example_aubiotest_AubioTestActivity_analyzeAudioViaAudacity(JNIEnv * env, jobject thisObj, jshortArray array, int iBufSize, jboolean bReset ,int iLastDetect, jintArray iFFTValues){
	return performAudacityFFT(env, thisObj, array, bReset, &stPreprocess, iLastDetect, iFFTValues);
}

JNIEXPORT jfloat JNICALL Java_com_example_aubiotest_AubioTestActivity_analyzeAudioViaAudacityAC(JNIEnv * env, jobject thisObj, jshortArray array, int iBufSize, jboolean bReset,int iLastDetect, jintArray iFFTValues){
	return performAudacityFFT(env, thisObj, array, bReset, &stPreprocessAC, iLastDetect, iFFTValues);
}

JNIEXPORT void JNICALL Java_com_example_aubiotest_AubioTestActivity_endRecord(JNIEnv * env, jobject thisObj)
{
	LOGE("endRecord()+");
...
JNIEXPORT void JNICALL Java_com_example_aubiotest_AubioTestActivity_encodeRS(JNIEnv * env, jclass jcls, jintArray array, int iCount, int numECCodewords)
{
	LOGE("encodeRS()\n");
	DECLARE_JNIENV_WITHOUT_RETURN()
...
JNIEXPORT void JNICALL Java_com_example_aubiotest_AubioTestActivity_decodeRS(JNIEnv * env, jclass jcls, jintArray array, int iCount, int numECCodewords)
{
	LOGE("decodeRS()\n");
	DECLARE_JNIENV_WITHOUT_RETURN()
	jint* data = jni_env->GetIntArrayElements(array, NULL);
...
JNIEXPORT jboolean JNICALL Java_com_example_aubiotest_AubioTestActivity_receiveAudioBufFromCam(JNIEnv * env, jobject obj, jstring strPath)
{
	DECLARE_JNIENV_WITH_RETURN()
	jboolean iRet = false;
...
JNIEXPORT jboolean JNICALL Java_com_example_aubiotest_AubioTestActivity_receiveAudioBufThreadRunning(){
	return mReceiveAudioThread != 0;
}

JNIEXPORT jboolean JNICALL Java_com_example_aubiotest_AubioTestActivity_stopReceiveAudioBufThread(){
	if(mReceiveAudioThread){
		stopReceiveAudioBuf();
		return true;
	}
